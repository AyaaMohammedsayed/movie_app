import 'package:movie_app/features/details_screen/data/model/movie_suggestions_response/torrent.dart';
...
class MovieB {
  ...
  factory MovieB.fromJson(Map<String, dynamic> json) => MovieB(
    id: json['id'] as int?,
