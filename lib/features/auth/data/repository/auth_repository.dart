...
class AuthRepository {
  ...
  Future<Either<Failure, LoginResponse>> loginWithGoogle(String email,String id,String name) async {
    try {
      final response = await _authRemoteAPIDataSource.loginWithGoogle(email,id,name);
